...
public class OAuth2Controller {
	...
	oauth2.setAccessTokenLocation(updated.getAccessTokenLocation());
	oauth2.setAccessTokenUrl(updated.getAccessTokenUrl());
	oauth2.setAuthorizationUrl(updated.getAuthorizationUrl());
